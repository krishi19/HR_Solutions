        ...
        listener: (ctx, loginState) {
          if (loginState.userModel != null) {
            Navigator.pushAndRemoveUntil(
              context,
              CupertinoPageRoute(builder: (ctx) => JobsPage()),
              (route) => false,
            );
          }
        },
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: const Padding(
                          ...
                          child: Text('Forgot Password?', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400)),
                        ),
                      ),
                    ),
                    const SizedBox(
                    ...
                    RaisedButton(
                      onPressed: () {
                        ...
                        context.read<AuthCubit>().loginUser(email: 'anita12joc@gmail.com', password: 'Anita123');
                      },
                    ...
                    GestureDetector(
                      ...
                      child: RichText(
                        text: const TextSpan(children: [
                          TextSpan(text: 'Not a member?', style: TextStyle(color: Color(0xff676767), fontSize: 16, fontWeight: FontWeight.w500)),
                          TextSpan(text: 'Register Now', style: TextStyle(color: Color(0xff202C7B), fontSize: 16, fontWeight: FontWeight.bold))
                        ]),
                      ),
                    )
                  ],
