            ...
            child: Container(
              ...
              child: const Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(border: InputBorder.none, hintText: 'Enter new password'),
                ),
              ),
            ),
          ),
          ...
          Padding(
            ...
            child: Container(
              ...
              child: const Padding(
                padding: EdgeInsets.only(left: 10),
                child: TextField(
                  decoration: InputDecoration(border: InputBorder.none, hintText: 'Re-enter your new Password'),
                ),
              ),
            ),
          ),
